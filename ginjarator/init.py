...
def _main_ninja_for_template(
    ...
    *,
    ...
    state_path = fs.resolve(paths.template_state_path(template_name))
    depfile_path = fs.resolve(paths.template_depfile_path(template_name))
    dyndep_path = fs.resolve(paths.template_dyndep_path(template_name))
    render_stamp_path = fs.resolve(
        paths.template_render_stamp_path(template_name)
    )
    scan_done_stamp_path = fs.resolve(paths.internal_path("scan-done.stamp"))
...
def init(
    *,
    ...
    main_ninja_path = fs.resolve(paths.internal_path("main.ninja"))
